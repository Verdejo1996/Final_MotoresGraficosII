...
{
    internal static Controller_Player player;
    ...
    internal static new Renderer renderer;
    ...
    public virtual void FixedUpdate()
    {
        ...
        if (GameManager.actualPlayer == playerNumber && GameManager.activeMove == true)
        {
            Movement();
        }
    }
    ...
    private void Update()
    {
        if (GameManager.actualPlayer == playerNumber && GameManager.changeCamera == false && GameManager.activeMove == true)
        {
            Jump();
            if (SomethingLeft())
            {
    ...
    {
        if(GameManager.activeMove == true)
        {
