...
public class Controller_Camera : MonoBehaviour
{
    ...
    {     
        if(players[GameManager.actualPlayer] != null)
        {
            ...
            Vector3 delta = players[GameManager.actualPlayer].transform.position - _camera.ViewportToWorldPoint(new Vector3(0.5f, 0.4f, point.z)); //(new Vector3(0.5, 0.5, point.z));
